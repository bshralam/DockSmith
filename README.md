...
2) Key Features:
- Ligand Preparation: Automatically processes a ligand library, converting SMILES to 3D structures, adding hydrogens, and generating pdbqt files using RDKit.
...
3) Tools Used: Python, RDKit, AutoDock Vina, Pandas. 
